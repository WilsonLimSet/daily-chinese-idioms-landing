...
const SERIES: DramaSeries[] = [
  ...
  },
  {
    ...
    englishName: 'Never-Ending Summer',
    chineseName: '炽夏',
    pinyin: 'Chì Xià',
    year: '2026',
    synopsis:
    ...
    postPrefix: 'never-ending-summer-',
    platforms: ['Mango TV', 'Hunan TV', 'iQIYI'],
  ...
  },
  {
    ...
    postPrefix: 'love-for-you-',
    platforms: ['Mango TV', 'WeTV'],
  ...
  },
  {
    ...
    englishName: 'Key to the Phoenix Heart',
    chineseName: '雀骨',
    pinyin: 'Què Gǔ',
    year: '2026',
    synopsis:
      "Xiao Wuyi (萧无衣), the disgraced 'demon general' heir of a fictional princedom who secretly bears the stigma of regicide, is forced into a contract marriage with Xie Jiayu (谢嘉鱼), the Grand Tutor's daughter and a master of Mohist mechanism arts, installed as his secondary consort. Together they unravel a mystery about their true origins and fight a court conspiracy, moving from a political arrangement to a life-and-death bond. The native title 雀骨 ('sparrow bone') plays against the English 'phoenix' framing. An original-screenplay costume romance starring Neo Hou Minghao and Ai Mi; premiered July 11, 2026 on iQIYI, 28 episodes.",
    postPrefix: 'key-to-the-phoenix-heart-',
    platforms: ['iQIYI'],
