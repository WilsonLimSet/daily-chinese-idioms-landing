...
const PARALLEL_LIMIT = 10; // Process 10 idioms at once
...
async function createTagalogTranslationFast() {
  console.log(`\n🚀 Fast parallel translation to ${LANG_NAME} (${LANG_CODE})...\n`);
...
createTagalogTranslationFast().catch(error => {
  console.error('\n❌ Fatal error:', error);
  process.exit(1);
});
