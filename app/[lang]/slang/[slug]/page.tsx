    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{getTranslation(lang, 'slangOrigin')}</h2>
        ...
        {/* Examples */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{getTranslation(lang, 'slangExamples')}</h2>
        ...
        <section className="mb-10">
          <p className="text-sm text-gray-500">
            ...
            {Object.entries(LANGUAGES)
              ...
              .map(([l, name], i, arr) => (
                <span key={l}>
                  <Link href={`/${l}/slang/${slug}`} className="text-purple-600 hover:text-purple-700">{name}</Link>
                  {i < arr.length - 1 ? ', ' : ''}
                </span>
              ))}
          </p>
        ...
        {related.length > 0 && (
          <section className="mt-12 pt-10 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">{getTranslation(lang, 'slangRelated')}</h2>
