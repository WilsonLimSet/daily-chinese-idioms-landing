---
title: >-
  Chinesische Schriftzeichennamen in First Frost: Was 温以凡, 桑延, 霜降 und 败降
  wirklich bedeuten
date: '2026-04-14'
characters: ''
pinyin: ''
...
description: >-
  Chinesische Schriftzeichennamen haben mehr Gewicht als die meisten westlichen
  Namen – sie werden nach Bedeutung, Klang und der Form des Schicksals einer
  Person ausgewählt. Hier ist, was die Namen in First Frost (难哄) wirklich
  bedeuten und warum die Namenswahl des Dramas viel stille Arbeit leistet, die
  Untertitel nicht übersetzen können.
---
...
Ein Chengyu für einen Namen, der sein Versprechen hält, ist [名副其实](/blog/ming-fu-qi-shi) – *der Name entspricht der Realität*. Wenn chinesische Eltern ein Kind benennen, stellen sie eine Behauptung darüber auf, wer dieses Kind ihrer Hoffnung nach werden soll. 名副其实 ist die Hoffnung, dass das Kind in diese Behauptung hineinwächst.
...
**温** bedeutet wörtlich *warm*. Es ist auch ein chinesischer Familienname mit einer langen Geschichte, der in mehreren Dynastien vorkommt. Als Namenszeichen trägt 温 Assoziationen mit Wärme des Temperaments, Sanftmut und der klassischen Tugend 温良 (*wēn liáng*) – warm und freundlich.
...
**以** ist ein Funktionswort. Es bedeutet "mit", "mittels", "um zu". In einem Namen wird es selten wegen seiner Bedeutung gewählt – es wird als anmutige Verbindung zwischen dem Familiennamen und dem zweiten Namenszeichen gewählt.
...
**凡** bedeutet *gewöhnlich*, *gemein*, *von dieser Welt* (im Gegensatz zu himmlisch oder heilig). Es ist kein auffälliges Zeichen. Es strebt nicht nach Größe.
...
Wen Yifans Spitzname **霜降** (*Shuāngjiàng*, *Frost's Descent*) ist der 18. der 24 chinesischen Sonnenperioden – wir haben sein volles kulturelles Gewicht in unserem [Sonnenperioden-Leitfaden zu 霜降](/blog/first-frost-shuangjiang-solar-term-chinese-heroine-name) entschlüsselt.
...
**桑** ist der Maulbeerbaum. Als Familienname ist er alt, aber ungewöhnlich – nicht unter den hundert häufigsten chinesischen Nachnamen. Der Maulbeerbaum trägt schweres kulturelles Gepäck: Er ist der Baum, dessen Blätter Seidenraupen füttern, die Grundlage der chinesischen Seidenindustrie seit fünftausend Jahren.
...
**延** bedeutet *erweitern, verlängern, fortsetzen*. Es ist ein Zeichen, das oft für erstgeborene Söhne oder für Kinder gewählt wird, von denen Eltern hoffen, dass sie die Familie weiterführen werden.
...
Wen Yifan sieht den Handle lange bevor sie ihn versteht. Das ist der Sinn eines guten chinesischen Wortspiels: Es tut seine Arbeit, ob der Empfänger weiß, was passiert oder nicht. Der Handle [名副其实](/blog/ming-fu-qi-shi) – der Name entspricht der Realität – beschreibt Sang Yans tatsächlichen Geisteszustand lange bevor er ihn jemals laut zugibt.
...
*Entdecken Sie weiter: Für das volle kulturelle Gewicht von Wen Yifans Spitznamen, siehe unseren [Sonnenperioden-Leitfaden zu 霜降](/blog/first-frost-shuangjiang-solar-term-chinese-heroine-name). Für die Chengyu, die den Bogen dieses Paares beschreiben, siehe unsere [8 Redewendungen, die jeder First Frost-Fan kennen sollte](/blog/first-frost-chinese-idioms-every-fan-should-know).*

*Ausgewählte chinesische Redewendungen: [名副其实 — Der Name entspricht der Realität](/blog/ming-fu-qi-shi), [举世闻名 — Weltberühmt](/blog/ju-shi-wen-ming), [风华正茂 — In der vollen Blüte der Jugend](/blog/feng-hua-zheng-mao). Sehen Sie sich unseren [Hub für chinesische Sprichwörter](/proverbs) an und durchsuchen Sie alle [1.000+ chinesischen Redewendungen](/blog).*
