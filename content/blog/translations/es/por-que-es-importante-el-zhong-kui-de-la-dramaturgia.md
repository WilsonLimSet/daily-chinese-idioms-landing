...
description: >-
  Zhong Kui no es solo un luchador, es un guardián del hogar. Explora por qué la
  gente cuelga su imagen en Año Nuevo y Duanwu, cómo 年画 difunde el culto y por
  qué los murciélagos (蝠) señalan 福 y 五福.
...
## 防患未然 (fáng huàn wèi rán) — "Prevenir problemas antes de que ocurran"
...
## 防微杜渐 (fáng wēi dù jiàn) — "Detener pequeños problemas antes de que crezcan"
...
## 温故知新 (wēn gù zhī xīn) — "Revisar lo antiguo para entender lo nuevo"
...
## 推陈出新 (tuī chén chū xīn) — "Crear lo nuevo a partir de lo viejo"
