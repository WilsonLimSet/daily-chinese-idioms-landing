---
title: >-
  Почему это называется 'Погоня за нефритом'? Глубокая символика 玉 в китайской
  культуре
date: '2026-03-18'
characters: ''
pinyin: ''
...
description: >-
  Нефрит — это не просто драгоценный камень в Китае — он представляет
  добродетель, характер и моральное совершенство. Узнайте, что означает 玉 в
  китайских идиомах и почему он центральен в популярной драме Погоня за нефритом
  (逐玉).
---
