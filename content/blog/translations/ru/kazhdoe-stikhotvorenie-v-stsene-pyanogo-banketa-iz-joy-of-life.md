---
title: >-
  Каждое стихотворение в сцене пьяного банкета из Joy of Life, объясненное
  (Сезон 1 Эпизод 27)
date: '2026-04-24'
characters: ''
pinyin: ''
...
description: >-
  Четырехминутная сцена, в которой Фан Сян читает классическую китайскую поэзию
  в состоянии алкогольного опьянения, является самым знаковым моментом в Joy of
  Life. Вот список стихотворений, которые он упоминает, кто их написал и почему
  каждое из них имеет особое значение — аннотировано для англоязычных зрителей.
...
## Другие упомянутые произведения
