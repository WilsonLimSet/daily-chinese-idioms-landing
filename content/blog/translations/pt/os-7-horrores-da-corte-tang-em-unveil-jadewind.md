---
title: >-
  Os 7 Horrores da Corte Tang: Cada Caso em 逐玉 Explicado Através de Idiomas
  Chineses
date: '2026-03-29'
characters: ''
pinyin: ''
...
description: >-
  Fogo demoníaco. Paredes sangrentas. Noivas esqueléticas. Estrelas fabricadas.
  Cada um dos 7 casos de 逐玉 esconde uma verdade devastadora sobre poder e
  injustiça na corte Tang.
...
[柳暗花明](/blog/liu-an-hua-ming) — o momento em que você empurra através de salgueiros densos para uma clareira inesperada de flores — descreve o avanço de Li Peiyi neste primeiro caso. Cada avenida de investigação parece bloqueada pelo protocolo da corte, interferência de facções e a narrativa oficial de "fogo demoníaco." Então, um único detalhe forense — o tipo de acelerante usado — abre o caso. A escuridão dos salgueiros nunca foi natural; alguém os plantou.
...
A investigação de Li Peiyi através deste caso é [一波三折](/blog/yi-bo-san-zhe) em sua forma mais agonizante. Cada solução aparente revela uma camada mais profunda: a gravidez fantasma não é possessão, é droga; as drogas não vêm de uma fonte externa, vêm da farmácia do palácio; a farmácia não age sozinha, está cumprindo pedidos dos aliados do chanceler. Três reviravoltas, cada uma pior que a anterior.
...
O idioma [愚公移山](/blog/yu-gong-yi-shan) — o velho que decide mover uma montanha carregando-a cesta por cesta, e cujos descendentes continuam o trabalho — se encaixa na abordagem de Li Peiyi em toda a investigação, mas se cristaliza aqui. Ela está movendo uma montanha de corrupção institucional um caso de cada vez, um corpo de cada vez, uma peça de evidência de cada vez. A montanha não quer se mover. Ela não para.
...
*Mais leituras sobre 逐玉: [A Verdadeira Dinastia Tang por Trás do Drama](/blog/unveil-jadewind-real-tang-dynasty-history-astronomy-changan) | [A Tradição de Detetive de 1.000 Anos por Trás de Li Peiyi](/blog/unveil-jadewind-judge-dee-chinese-detective-fiction-gongan) | [Aprenda Chinês Assistindo ao Drama](/blog/unveil-jadewind-learn-chinese-tang-dynasty-vocabulary)*

*Explore nossos [1.000+ idiomas chineses](/blog) com pronúncias, significados e exemplos. Comece com os idiomas do drama: [柳暗花明](/blog/liu-an-hua-ming), [因果报应](/blog/yin-guo-bao-ying), [愚公移山](/blog/yu-gong-yi-shan).*
