---
title: >-
  Citações Famosas de First Frost Explicadas: A Arte Chinesa de 哄 (Acalmar) como
...
description: >-
  O drama chinês First Frost (难哄) tira seu título de uma única palavra — 哄
  (hǒng), o verbo chinês intraduzível que significa 'acalmar, suavizar ou
  conquistar gentilmente'. Aqui está o que realmente significa, como as citações
  famosas do drama o usam como arma e por que 哄 é, sem dúvida, uma linguagem de
  amor chinesa.
---
...
> "Seu desaparecimento sem uma palavra — isso é o que realmente me destruiu."
...
> **凡夫俗女**
> *Fán fū sú nǚ*
> "Mulheres comuns, esposas comuns"
...
Sang Yan é descendente moderno de [相敬如宾](/blog/xiang-jing-ru-bin) — ele trata Wen Yifan com o respeito de nível de convidado que a frase clássica prescreve, mas ele faz isso através de pequenos atos diários e específicos. Ele muda de assunto quando ela parece cansada. Ele mantém seus lanches favoritos da noite na geladeira. Ele não pergunta sobre sua infância até que ela esteja pronta para oferecê-la.

O idioma chinês [无微不至](/blog/wu-wei-bu-zhi) — "atento a cada detalhe, não importa quão pequeno" — captura exatamente esse tipo de cuidado. Descreve a atenção de um pai a um bebê, ou de um cuidador dedicado a um inválido. Em *First Frost*, descreve um homem apaixonado.
...
**你慢慢来** (*nǐ màn màn lái*). Três sílabas. O equivalente chinês mais próximo de "sem pressa" ou "no seu próprio ritmo". É o que Sang Yan diz quando ela hesita antes de dizer algo difícil. Uma linha direta para o chengyu [持之以恒](/blog/chi-zhi-yi-heng) — *persevere constantemente, ao longo do tempo* — na linguagem da intimidade.
...
*Continue explorando: [Ditos chineses sobre o amor](/blog/lists/chinese-sayings-about-love) — o registro poético chinês clássico do romance. Ou navegue por [Ditos chineses sobre paciência](/blog/lists/chinese-sayings-about-patience) — a virtude silenciosa que torna 哄 possível.*

*Expressões idiomáticas chinesas apresentadas neste artigo: [相敬如宾 — Respeito mútuo na intimidade](/blog/xiang-jing-ru-bin), [无微不至 — Atento a cada detalhe](/blog/wu-wei-bu-zhi), [持之以恒 — Persevere constantemente](/blog/chi-zhi-yi-heng), [一心一意 — Devoção de coração inteiro](/blog/yi-xin-yi-yi). Ou navegue pelo nosso [hub de provérbios chineses](/proverbs) e todos os [mais de 1.000 idiomas chineses](/blog).*
